        ...
        Run: func(_ *cobra.Command, _ []string) {
            ...
            switch target {
                case targetEnumKafka:
                    benchmark = internal.ConnectKafka(config.KafkaConfig, numberOfMessages, sizeOfMessage)
                case targetEnumPulsar:
                    benchmark = internal.ConnectPulsar(config.PulsarConfig, numberOfMessages, sizeOfMessage)
                case targetEnumRedpanda:
                    benchmark = internal.ConnectKafka(config.RedpandaConfig, numberOfMessages, sizeOfMessage)
            }
